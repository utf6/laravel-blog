                    ...
                    <ul class="nav simplewind-nav pull-right">
                        <li class="light-blue">
                            <a data-toggle="dropdown" href="#" class="dropdown-toggle">
                                ...
                                <span class="user-info">欢迎, {{ auth('admin')->user()->nickname }}</span>
                                <i class="fa fa-caret-down"></i>
                            </a>
                            <ul class="user-menu pull-right dropdown-menu dropdown-yellow dropdown-caret dropdown-closer">
                                <li>
                                    <a href="javascript:openapp('{{ route('setting.site') }}','index_site','网站信息');">
                                        <i class="fa fa-cog"></i> 网站信息
                                    </a>
                                </li>
                                <li>
                                    <a href="javascript:openapp('{{ route('user.info') }}', 'index_info', '修改信息');">
                                        <i class="fa fa-user"></i> 修改信息</a>
                                </li>
                                <li>
                                    <a href="javascript:openapp('{{ route('user.password') }}', 'index_password', '修改密码');">
                                        <i class="fa fa-lock"></i> 修改密码
                                    </a>
                                </li>
                                <li><a href="{{ route('logout') }}"><i class="fa fa-sign-out"></i> 退出</a></li>
                            </ul>
                        </li>
                    </ul>
                </div>
        ...
        <div class="main-container container-fluid">
                        ...
                        <li>
                            ...
                            <ul class="submenu" style="display: none;">
                                <li class="">
                                    ...
                                    <ul class="submenu" style="display: none;">
                                        <li>
                                            <a href="javascript:openapp('{{ route('user.password') }}','195Admin','修改密码',true);">&nbsp;
                                                <i class="fa fa-angle-double-right"></i>
                                                <span class="menu-text">修改密码</span>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="javascript:openapp('{{ route('user.info') }}','196Admin','修改信息',true);">&nbsp;
                                                <i class="fa fa-angle-double-right"></i>
            ...
            <div class="main-content">
                ...
                <div class="page-content" id="content">
                    <iframe src="{{ route('welcome') }}" style="width:100%;height: 100%;" frameborder="0" id="appiframe-0" class="appiframe"></iframe>
                </div>
            </div>
        </div>
    </div>
